                ...
                <div>
                    ...
                    <section className='section --fit-content'>
                        <div className='section__inner'>
                            <div className='flexbox'>
                                ...
                                <div>
                                    <h2 className='icon_header'><DoubleArrow />Stay on Track</h2>
                                    ...
                                    <h2 className='icon_header'><LocalCafe />Peace of Mind</h2>
                                    ...
                                    <h2 className='icon_header'><HowToReg />Student Data</h2>
                    ...
                    <section className='section --fit-content'>
                        <div className='section__inner'>
                            <div className='flexbox'>
                                <div>
                                    <h2 className='icon_header'><Cached />Habit Building</h2>
                                    ...
                                    <h2 className='icon_header'><Today />Accountability</h2>
                                    <p>Spotlight offers a clear and concise look at missed and attended blocks.</p>
                                    <h2 className='icon_header'><ThumbUp />Ease of Use</h2>
